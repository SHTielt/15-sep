...
<p>
    <a href="<?php echo "http://localhost:8080/sociaalhuis/organisatie-formulier-bestuur?organisatieid=".$verenigingId; ?>" class="buttonback" title="Terug naar bestuur organisatie">&nbsp;Terug</a>
</p>
