...
?>
<div id="actionsdiv">
    <a href="<?php echo "http://localhost:8080/sociaalhuis/organisatie-formulier-contact?organisatieid=".$verenigingId; ?>" class="buttonback" title="<?php echo "Terug naar contact van ".$gezochteVer[0]['verNaam']; ?>">&nbsp;Terug</a>
...
<form id="frmContactPersoon" method="POST" action="http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/contactpersoon.control.php" class="form-horizontal" enctype="multipart/form-data">
            ...
            <!--<hr style="width:85%; margin-bottom: 1.5em; height: 0.1px; text-align: center; border-style: solid;" />-->
