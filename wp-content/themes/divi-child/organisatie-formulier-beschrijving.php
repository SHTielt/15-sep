...
<div id="rodebalk" class="alert-info">
                <strong>&nbsp;<?php if(empty($_POST['verenigingId']) && empty($_SESSION['laatsteid'])){echo "Organisatie beschrijving toevoegen";} else {echo "Organisatie beschrijving wijzigen";}?></strong>
...
{
?>
 <a href="<?php echo "http://localhost:8080/sociaalhuis/organisatie-formulier-bestuur?organisatieid=".$verId;?>" class="pull-right buttonnext" title="<?php echo "Naar bestuur van ".$result[0]['verNaam']; ?>">&nbsp;Naar bestuur</a> 
<?php	
}
?>
...
<form id="frmVereniging" method="POST" action="http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/organisatiebeschrijving.control.php" class="form-horizontal" enctype="multipart/form-data" >
