...
*/
 ...
 $lijst = $objectS->selectVerenigingById(23);
...
<thead>
<tr>
	<th>VerId</th><th>Naam</th><th>Locatie</th><th>Omschrijving</th><th>Werkingsgebied</th><th>Website</th><th>Facebook</th><th>Beschrijving</th><th>Actief</th><th>WPUserId</th><th>RechtsVormId</th><th>secid</th>
</tr>
</thead>
    <tbody>
    	<?php
    ...
    <tr><td><?php  echo $result['verID']; ?></td><td><?php  echo $result['verNaam']; ?></td><td><?php  echo $result['verLocatie']; ?></td><td><?php  echo $result['verOmschrijving']; ?></td>
    	...
    	<td><?php  echo $result['verActief']; ?></td><td><?php  echo $result['verWPUserID']; ?></td><td><?php  echo $result['rvID']; ?></td><td><?php  echo $result['secID']; ?></td>
    	</tr>
    	<?php
        }//end foreach
    ?>
