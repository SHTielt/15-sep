 ...
 */
 ...
 $objectS = new Bestuurder();
 $bestuurdersLijst = $objectS->selectBestuurderByVerenigingId(9);
...
<thead>
<tr>
	<th>BestId</th><th>Voornaam</th><th>Naam</th><th>Info</th><th>Email</th><th>gsm</th><th>Telefoon</th><th>CVID</th><th>Funcid</th><th>FuncNaam</th><th>FuncInfo</th><th>Verid</th>
</tr>
</thead>
<tbody>
	<?php
    ...
    <tr><td><?php  echo $result['bestID']; ?></td><td><?php  echo $result['bestVoornaam']; ?></td><td><?php  echo $result['bestNaam']; ?></td><td><?php  echo $result['bestInfo']; ?></td>
    	...
    	<td><?php  echo $result['cvID']; ?></td><td><?php  echo $result['funcID']; ?></td><td><?php  echo $result['funcNaam']; ?></td><td><?php  echo $result['funcInfo']; ?></td><td><?php  echo $result['verID']; ?></td>
    </tr>
    <?php
        }//end foreach
    ?>
