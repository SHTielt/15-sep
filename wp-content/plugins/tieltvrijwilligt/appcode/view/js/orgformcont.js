...
jQuery(document).ready(function () {
    ...
    jQuery("table").on("click", "button.btndelete", deleteContactPersoon);
    
    //3. snel sorteren dankzij de expando sortKey
    var tabel = jQuery("#contactTabel");
...
function deleteContactPersoon() {
                ...
                */
                ...
                if(r == true)
                {
                    window.location.href = 'http://localhost:8080/sociaalhuis/wp-content/plugins/tieltvrijwilligt/appcode/control/contactpersoon.control.php?contactpersoonid=' + id;
                    return false; //to prevent window.location.href is assigned badly;
                }
                             
                                
            } //end deleteContactPersoon