...
BEGIN
	SELECT bestID, bestVoornaam, bestNaam, bestInfo, bestEmail, bestGSM, bestTelefoon, cvID, verID, sh_functies.funcID, sh_functies.funcNaam as funcNaam FROM sh_bestuurders left outer join sh_functies on sh_bestuurders.funcID = sh_functies.funcID where verID = pverID;
END //
DELIMITER ;
